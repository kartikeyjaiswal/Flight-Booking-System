    ...
    return (
        <div className="flex justify-center items-center h-[calc(100vh-80px)] bg-gray-50">
            <div className="bg-white p-8 rounded shadow-lg w-full max-w-md">
                <h2 className="text-2xl font-bold mb-6 text-[#001b94] text-center">Login to your account</h2>
                ...
                <div className="mt-4 text-center text-sm">
                    Don't have an account? <Link to="/register" className="text-[#001b94] font-bold hover:underline">Register</Link>
                </div>
            </div>
        </div>
    );
